---
title: "Stop Automating the Wrong Thing: A 50-Year Pattern That Explains Why Most AI Deployments Disappoint"
pubDatetime: 2026-04-10T12:00:00.000Z
description: "Ford did not speed up invoice processing. FedEx did not make deliveries faster. Progressive did not schedule adjusters more efficiently. Each one noticed a technology had opened a new door — and walked through it. AI is opening those doors right now."
tags:
  - technology-adoption
  - ai
  - strategy
...
In 1979, Frederick Smith's Federal Express was four years old and losing money at a pace that would have killed most companies. Smith had a thesis: businesses would pay a premium for overnight delivery if the package arrived reliably and on time. The problem was reliability. Packages disappeared into the logistics system. Nobody — not the sender, not the recipient, not FedEx itself — knew exactly where anything was at any given moment.
...
The enabling technology was barcode scanning and a centralised computing network that could track every package at every handling point. Those technologies existed. What didn't exist, before COSMOS, was a process built around continuous visibility as the product. Every other carrier was selling delivery. FedEx decided to sell *certainty*.

COMOS made it possible, for the first time, to tell a customer: your package is here, right now, at this facility, and it will be there tomorrow. That wasn't a feature. It was a redesign of what the service was. The tracking number — which seems obvious now — didn't exist before. FedEx invented it because COSMOS required it.
...
CIGNA ran a massive business process reengineering programme in the early 1990s — over 20 separate initiatives. They saved more than $100 million in aggregate. By almost any measure, a success.
...
Allianz Partners deployed generative AI in their claims process in 2024. A claim that previously required 45 minutes of human processing now takes 90 seconds, end-to-end, from intake to resolution. That's not a faster human. That's a different process.

The enabling capability: a generative AI system that can read unstructured documents, extract the relevant data, compare against policy terms, and produce a resolution — without a human touching each step. That door wasn't open five years ago. It's open now.
...
If you're leading transformation inside an established organisation right now, you're probably being asked to find AI use cases. Build a roadmap. Identify efficiency gains. Show a business case.
...
Real-time synthesis of customer signals across every touchpoint simultaneously, feeding into a personalised response in the moment — possible now, wasn't before.
